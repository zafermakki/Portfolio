  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'TypeScript', level: 94, color: 'from-blue-500 to-blue-700' },
        { name: 'Tailwind CSS', level: 98, color: 'from-cyan-400 to-cyan-600' },
    ...
    },
    {
      ...
      skills: [
        { name: 'Django', level: 98, color: 'from-green-400 to-green-600' },
